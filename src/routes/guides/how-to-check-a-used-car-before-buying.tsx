...
const CHECK_GROUPS = [
  { title: "Paper trail", items: ["VIN decoded and cross-checked against the listing", "Auction or dealer history reviewed where available", "Service history checked for consistency", "Odometer readings checked for gaps or inconsistency"] },
  { title: "Damage history", items: ["Accident history reviewed where reported", "Flood-damage indicators checked", "Fire-damage indicators checked", "Structural or frame damage assessed where visible"] },
  { title: "Mechanical", items: ["Engine checked for leaks, noise, and smoke on start", "Transmission behavior checked through the available gear range", "OBD scan for stored fault codes", "Cold-start behavior observed where possible"] },
  { title: "Body and interior", items: ["Paint checked for mismatched panels or overspray", "Airbags and safety systems checked for prior deployment", "Interior electronics and infotainment tested", "Cameras and sensors tested where fitted"] },
  { title: "Wear items", items: ["Tire wear and tread checked for uneven patterns", "Brakes checked for wear and responsiveness", "Keys and remotes confirmed present and functional"] },
];
